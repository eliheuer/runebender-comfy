// Ported from runebender-xilem/src/editing/edit_types.rs (Apache-2.0).

//! Edit types for undo grouping.

/// Type of edit being performed. Used to group consecutive edits of
/// the same type into a single undo action.
