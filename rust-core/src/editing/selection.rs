// Ported from runebender-xilem/src/editing/selection.rs (Apache-2.0).
...
//! cloned for undo snapshots. Mutations produce a new set
//! (copy-on-write via `Arc::make_mut`). The `BTreeSet` gives
